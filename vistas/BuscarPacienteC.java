 ...
 * @author Usuario
 */
public class BuscarPacienteC extends javax.swing.JDialog {
     ...
     */
    public BuscarPacienteC(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void listar() {
        ...
        try {
            ArrayList<Paciente> pacientes = hcDAO.listarPacientesHC();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPacienteC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarPacienteC dialog = new BuscarPacienteC(new javax.swing.JDialog(), true);
